...
# define _C_CURSOR_RESET	write(1, CU_RESET, 6)
# define _C_CURSOR_LOAD	write(1, CU_LOAD, 3)
# define _C_CURSOR_SAVE	write(1, CU_SAVE, 3)
# define _C_CLEAR_SCREEN	write(1, CL_SCREEN, 4)
...
# define CURSOR_RESET	_C_CURSOR_RESET;
# define CURSOR_LOAD	_C_CURSOR_LOAD;
# define CURSOR_SAVE	_C_CURSOR_SAVE;
# define CLEAR_SCREEN	_C_CLEAR_SCREEN;
